...
BBL_MODULE(oiio) {
  ...
  bbl::Class<OIIO::ImageCache>()
      ...
      .m(bbl::Wrap((bool(OIIO::ImageCache::*)(OIIO::string_view, OIIO::TypeDesc,
                                              const void *)) &
                       OIIO::ImageCache::attribute,
                   [](OIIO::ImageCache &_this, char const *name,
                      OIIO::TypeDesc type, void const *data) -> bool {
      ...
      .m(bbl::Wrap((bool(OIIO::ImageCache::*)(OIIO::string_view, OIIO::TypeDesc,
                   ...
                   [](OIIO::ImageCache const &_this, char const *name,
                      OIIO::TypeDesc type, void *data) -> bool {
      ...
      .m((bool(OIIO::ImageCache::*)(OIIO::ustring, int, int, OIIO::ustring,
                                    OIIO::TypeDesc, void *)) &
             OIIO::ImageCache::get_image_info,
         "get_image_info")
      .m((bool(OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                    OIIO::ImageCache::Perthread *, int, int,
                                    OIIO::ustring, OIIO::TypeDesc, void *)) &
             OIIO::ImageCache::get_image_info,
         "get_image_info_from_handle")
      .m((bool(OIIO::ImageCache::*)(OIIO::ustring, OIIO::ImageSpec &, int, int,
                                    bool)) &
             OIIO::ImageCache::get_imagespec,
         "get_imagespec")
      .m((bool(OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                    OIIO::ImageCache::Perthread *,
                                    OIIO::ImageSpec &, int, int, bool)) &
             OIIO::ImageCache::get_imagespec,
         "get_imagespec_from_handle")
      .m((const OIIO::ImageSpec *(OIIO::ImageCache::*)(OIIO::ustring, int, int,
                                                       bool)) &
             OIIO::ImageCache::imagespec,
         "imagespec")
      .m((const OIIO::ImageSpec *(
             OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                  OIIO::ImageCache::Perthread *, int, int,
                                  bool)) &
             OIIO::ImageCache::imagespec,
         "imagespec_from_handle")
      .m((bool(OIIO::ImageCache::*)(OIIO::ustring, OIIO::ImageBuf &, int)) &
             OIIO::ImageCache::get_thumbnail,
         "get_thumbnail")
      .m((bool(OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                    OIIO::ImageCache::Perthread *,
                                    OIIO::ImageBuf &, int)) &
             OIIO::ImageCache::get_thumbnail,
         "get_thumbnail_from_handle")
      .m((bool(OIIO::ImageCache::*)(OIIO::ustring, int, int, int, int, int, int,
                                    int, int, int, int, OIIO::TypeDesc, void *,
                                    OIIO::stride_t, OIIO::stride_t,
                                    OIIO::stride_t, int, int)) &
             OIIO::ImageCache::get_pixels,
         "get_pixels_00")
      .m((bool(OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                    OIIO::ImageCache::Perthread *, int, int,
                                    int, int, int, int, int, int, int, int,
                                    OIIO::TypeDesc, void *, OIIO::stride_t,
                                    OIIO::stride_t, OIIO::stride_t, int, int)) &
             OIIO::ImageCache::get_pixels,
         "get_pixels_01")
      .m((bool(OIIO::ImageCache::*)(OIIO::ustring, int, int, int, int, int, int,
                                    int, int, OIIO::TypeDesc, void *)) &
             OIIO::ImageCache::get_pixels,
         "get_pixels_02")
      .m((bool(OIIO::ImageCache::*)(
             OIIO::ImageCache::ImageHandle *, OIIO::ImageCache::Perthread *,
             int, int, int, int, int, int, int, int, OIIO::TypeDesc, void *)) &
             OIIO::ImageCache::get_pixels,
         "get_pixels_03")
      .m((void(OIIO::ImageCache::*)(OIIO::ustring, bool)) &
             OIIO::ImageCache::invalidate,
         "invalidate_00")
      ...
      .m((OIIO::ImageCache::Tile * (OIIO::ImageCache::*)(OIIO::ustring, int,
                                                         int, int, int, int,
                                                         int, int)) &
             OIIO::ImageCache::get_tile,
         "get_tile")
      .m((OIIO::ImageCache::Tile *
          (OIIO::ImageCache::*)(OIIO::ImageCache::ImageHandle *,
                                OIIO::ImageCache::Perthread *, int, int, int,
                                int, int, int, int)) &
             OIIO::ImageCache::get_tile,
         "get_tile_from_handle")
